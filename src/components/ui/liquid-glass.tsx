...
/**
 * Apple-style "Liquid Glass" primitives (from 21st.dev), adapted for this
 * Vite + Tailwind 3 codebase.
 *
 * The refraction comes from the #glass-distortion SVG filter
 * (feTurbulence -> feDisplacementMap) applied over a backdrop-blur layer.
 *
 * BROWSER SUPPORT: the live distortion is a Chromium/Firefox effect. Safari/iOS
 * ignore the SVG filter on the backdrop and fall back to a plain frosted blur +
 * inset highlights (still a clean glass look, just without the wobble).
 *
 * Render <GlassFilter /> once near the root so #glass-distortion is defined.
 */
...
// SVG Filter Component - render once near the app root.
...
/**
 * On-brand demo: a liquid-glass CTA over a water photograph. (Replaces the
 * original macOS dock demo, whose Claude/Finder/Steam icons are off-brand.)
 */
